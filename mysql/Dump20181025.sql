...
INSERT INTO `producto_almacen` VALUES (1,1,0),(1,2,0),(1,3,0),(2,1,0),(2,2,0),(2,3,0),(3,1,0),(3,2,0),(3,3,0),(4,1,0),(4,2,0),(4,3,0),(5,1,0),(5,2,0),(5,3,0),(6,1,0),(6,2,0),(6,3,0),(7,1,0),(7,2,0),(7,3,0),(8,1,0),(8,2,0),(8,3,0);
    ...
    start transaction;
		if tipoMov=1 then -- Es un ingreso de productos 
			insert into movprod(idMovProd, idProducto, idAlmacen,cantIngr,CantSalida, fecha, hora, stock, idTrabajador, idUsuario, estado)
				values(idMovProd,idProd,idAlmac,cant, 0, now(), now(), stock, idTrab, idUser, true);
		else -- Es una salida de productos
			insert into movprod(idMovProd, idProducto, idAlmacen,cantIngr,CantSalida, fecha, hora, stock, idTrabajador, idUsuario, estado)
				values(idMovProd,idProd,idAlmac,0, cant, now(), now(), stock, idTrab, idUser, true);
        end if;
    commit;
END ;;
DELIMITER ;
...
-- Dump completed on 2018-10-25 16:01:59
