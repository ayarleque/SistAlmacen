...
INSERT INTO `almacen` VALUES (1,'Almacen 01',_binary ''),(2,'Almacen 02',_binary ''),(3,'Almacen 03',_binary '');
...
INSERT INTO `movprod` VALUES (1,7,1,150.00,0.00,'2018-10-30','17:24:07',150.00,NULL,1,_binary '','',''),(2,7,1,0.00,3.00,'2018-10-30','17:25:23',147.00,2,1,_binary '','hwkjh','aru-125');
...
INSERT INTO `producto_almacen` VALUES (1,1,0.00),(1,2,0.00),(1,3,0.00),(2,1,0.00),(2,2,0.00),(2,3,0.00),(3,1,0.00),(3,2,0.00),(3,3,0.00),(4,1,0.00),(4,2,0.00),(4,3,0.00),(5,1,0.00),(5,2,0.00),(5,3,0.00),(6,1,0.00),(6,2,0.00),(6,3,0.00),(7,1,147.00),(7,2,0.00),(7,3,0.00),(8,1,0.00),(8,2,0.00),(8,3,0.00);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `paMuestraDatosProdxAlmac`(
	idProd int, 
	serie varchar(20),
    idAlmac int
)
	...
	select p.descrip, m.marca, c.NomCategoria cat, p.modelo, p.nroSerie, p.ubicacion, p.obs,  p.unidMed,  p.precio,  p.foto, p.idProducto, pa.Cant
		from Producto p join Categoria c 
            ...
            join producto_almacen pa on p.idProducto=pa.idProducto
				where (p.idProducto=idProd or p.nroSerie=serie) and p.estado=true and (pa.idProducto=idProd and pa.idAlmacen=idAlmac);
...
-- Dump completed on 2018-10-30 19:02:41
