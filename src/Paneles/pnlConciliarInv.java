...
public class pnlConciliarInv extends javax.swing.JPanel {
    ...
    public pnlConciliarInv(MenuPrincipal princ, int idUser) {
        initComponents();
        principal=princ;
        listaAlmacen();
        ...
        modelo.addColumn("Cant. Encontrada");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("CONCILIAR INVENTARIO DE ALMACÉN");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        try {
            ...
            while (i < dtDetalle.getRowCount()) {
                cst = con.prepareCall("{call paConciliaExistencias (?,?,?)}");
            ...
            JOptionPane.showMessageDialog(null, "Existencias conciliadas correctamente");
            cst.close();
            con.close();
            ...
            try {
                ...
                Logger.getLogger(pnlConciliarInv.class.getName()).log(Level.SEVERE, null, ex1);
            }
