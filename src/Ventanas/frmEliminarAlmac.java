...
public class frmEliminarAlmac extends javax.swing.JFrame {

    int idAlm[];
    
    public frmEliminarAlmac() {
        initComponents();
    ...
    public void listaCat(){
        idAlm=ListaCombos.listaAlmacen(cboAlmacen, idAlm);
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ELIMINAR ALMACÉN");
        ...
        cboAlmacen.setFont(new java.awt.Font("Poetsen One", 0, 12)); // NOI18N
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        try{
            ...
            cst=con.prepareCall("{call paEliminaAlm (?)}");
            cst.setInt(1,idAlm[cboAlmacen.getSelectedIndex()]);
            cst.execute();
