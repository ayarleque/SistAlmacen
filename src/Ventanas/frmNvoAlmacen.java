...
public class frmNvoAlmacen extends javax.swing.JFrame {
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtAlmacen, javax.swing.GroupLayout.PREFERRED_SIZE, 169, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        try {
            ...
            cst=con.prepareCall("{call paIngresaAlmacen (?)}");
            cst.setString(1,txtAlmacen.getText());
            cst.execute();
            JOptionPane.showMessageDialog(null,"Almacén ingresado correctamente");
            /*
            switch (tipoLlama) {
